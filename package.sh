...
sudo chown $USER "$HOME/BillApplication_data/accounts.csv"
sudo chown $USER "$HOME/BillApplication_data/bills.csv"
sudo chown $USER "$HOME/BillApplication_data/missions.csv"
sudo chown $USER "$HOME/BillApplication_data/settings.csv"
